...
--  Fuente de verdad para Docker (initdb) y EF Core.
--  Tablas entre comillas = PascalCase (igual que ToTable en EF).
-- ============================================================
...
CREATE TABLE "Producto" (
    ...
    stock_minimo        INTEGER      NOT NULL DEFAULT 20 CHECK (stock_minimo >= 0),
